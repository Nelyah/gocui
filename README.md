...
[![Go Reference](https://pkg.go.dev/badge/github.com/nelyah/gocui.svg)](https://pkg.go.dev/github.com/jroimartin/gocui)
...
```
$ go get github.com/nelyah/gocui
```
...
```
$ go doc github.com/nelyah/gocui
```

Or visit [pkg.go.dev](https://pkg.go.dev/github.com/nelyah/gocui) to read
it online.
